...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "calc_density_old",
        "sources": [
            "calc_density_old.pyx"
        ]
    },
    "module_name": "calc_density_old"
}
END: Cython Metadata */
...
#define __PYX_HAVE__calc_density_old
#define __PYX_HAVE_API__calc_density_old
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'calc_density_old' */
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "calc_density_old"
extern int __pyx_module_is_main_calc_density_old;
int __pyx_module_is_main_calc_density_old = 0;

/* Implementation of 'calc_density_old' */
...
static const char __pyx_k_calc_density_old[] = "calc_density_old";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_calc_density_old_pyx[] = "calc_density_old.pyx";
...
static PyObject *__pyx_n_s_calc_density_old;
static PyObject *__pyx_kp_s_calc_density_old_pyx;
...
static PyObject *__pyx_pf_16calc_density_old_calc_density_old(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_position, PyObject *__pyx_v_ncells, PyObject *__pyx_v_L); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_16calc_density_old_1calc_density_old(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_16calc_density_old_calc_density_old[] = " Calculate charge density given particle positions\n    \n    Input\n      position  - Array of positions, one for each particle\n                  assumed to be between 0 and L\n      ncells    - Number of cells\n      L         - Length of the domain\n\n    Output\n      density   - contains 1 if evenly distributed\n    ";
static PyMethodDef __pyx_mdef_16calc_density_old_1calc_density_old = {"calc_density_old", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_16calc_density_old_1calc_density_old, METH_VARARGS|METH_KEYWORDS, __pyx_doc_16calc_density_old_calc_density_old};
static PyObject *__pyx_pw_16calc_density_old_1calc_density_old(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_position = 0;
  PyObject *__pyx_v_ncells = 0;
  PyObject *__pyx_v_L = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("calc_density_old (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ncells)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("calc_density_old", 1, 3, 3, 1); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_L)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calc_density_old", 1, 3, 3, 2); __PYX_ERR(0, 13, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "calc_density_old") < 0)) __PYX_ERR(0, 13, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("calc_density_old", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 13, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("calc_density_old.calc_density_old", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_16calc_density_old_calc_density_old(__pyx_self, __pyx_v_position, __pyx_v_ncells, __pyx_v_L);
...
static PyObject *__pyx_pf_16calc_density_old_calc_density_old(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_position, PyObject *__pyx_v_ncells, PyObject *__pyx_v_L) {
  double __pyx_v_dx;
  int __pyx_v_nparticles;
  PyArrayObject *__pyx_v_density = 0;
  PyObject *__pyx_v_p = NULL;
  PyObject *__pyx_v_plower = NULL;
  ...
  __Pyx_RefNannySetupContext("calc_density_old", 0);
 ...
 */
  __pyx_t_1 = __Pyx_PyNumber_Divide(__pyx_v_L, __pyx_v_ncells); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 25, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_3 = PyObject_Length(__pyx_v_position); if (unlikely(__pyx_t_3 == ((Py_ssize_t)-1))) __PYX_ERR(0, 27, __pyx_L1_error)
  __pyx_v_nparticles = __pyx_t_3;

  /* "calc_density_old.pyx":28
 * 
 *     cdef int nparticles = len(position)
 *     cdef np.ndarray[double, ndim=1] density = np.zeros([ncells])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  PyList_SET_ITEM(__pyx_t_4, 0, __pyx_v_ncells);
  __pyx_t_6 = NULL;
  ...
  __pyx_t_7 = ((PyArrayObject *)__pyx_t_1);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_density.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
  ...
  __pyx_t_7 = 0;
  __pyx_v_density = ((PyArrayObject *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "calc_density_old.pyx":30
 *     cdef np.ndarray[double, ndim=1] density = np.zeros([ncells])
 * 
 *     for p in position / dx:    # Loop over all the particles, converting position into a cell number             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_dx); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_PyNumber_Divide(__pyx_v_position, __pyx_t_1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (likely(PyList_CheckExact(__pyx_t_5)) || PyTuple_CheckExact(__pyx_t_5)) {
    ...
    __pyx_t_3 = -1; __pyx_t_1 = PyObject_GetIter(__pyx_t_5); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 30, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
  ...
  for (;;) {
    if (likely(!__pyx_t_8)) {
      if (likely(PyList_CheckExact(__pyx_t_1))) {
        ...
        __pyx_t_5 = PyList_GET_ITEM(__pyx_t_1, __pyx_t_3); __Pyx_INCREF(__pyx_t_5); __pyx_t_3++; if (unlikely(0 < 0)) __PYX_ERR(0, 30, __pyx_L1_error)
        #else
        __pyx_t_5 = PySequence_ITEM(__pyx_t_1, __pyx_t_3); __pyx_t_3++; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 30, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        #endif
      } else {
        if (__pyx_t_3 >= PyTuple_GET_SIZE(__pyx_t_1)) break;
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_5 = PyTuple_GET_ITEM(__pyx_t_1, __pyx_t_3); __Pyx_INCREF(__pyx_t_5); __pyx_t_3++; if (unlikely(0 < 0)) __PYX_ERR(0, 30, __pyx_L1_error)
        #else
        __pyx_t_5 = PySequence_ITEM(__pyx_t_1, __pyx_t_3); __pyx_t_3++; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 30, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        #endif
 ...
 */
    __pyx_t_5 = __Pyx_PyNumber_Int(__pyx_v_p); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 31, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_XDECREF_SET(__pyx_v_plower, __pyx_t_5);
    __pyx_t_5 = 0;

    /* "calc_density_old.pyx":32
 *     for p in position / dx:    # Loop over all the particles, converting position into a cell number
 *         plower = int(p)        # Cell to the left (rounding down)
 *         offset = p - plower    # Offset from the left             # <<<<<<<<<<<<<<
 *         density[plower] += 1. - offset
 ...
 */
    __pyx_t_5 = PyNumber_Subtract(__pyx_v_p, __pyx_v_plower); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 32, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_XDECREF_SET(__pyx_v_offset, __pyx_t_5);
    __pyx_t_5 = 0;

    /* "calc_density_old.pyx":33
 *         plower = int(p)        # Cell to the left (rounding down)
 *         offset = p - plower    # Offset from the left
 *         density[plower] += 1. - offset             # <<<<<<<<<<<<<<
 *         density[(plower + 1) % ncells] += offset
 ...
 */
    __Pyx_INCREF(__pyx_v_plower);
    __pyx_t_5 = __pyx_v_plower;
    __pyx_t_4 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_density), __pyx_t_5); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 33, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_6 = __Pyx_PyFloat_SubtractCObj(__pyx_float_1_, __pyx_v_offset, 1., 0, 0); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 33, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_9 = PyNumber_InPlaceAdd(__pyx_t_4, __pyx_t_6); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 33, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    if (unlikely(PyObject_SetItem(((PyObject *)__pyx_v_density), __pyx_t_5, __pyx_t_9) < 0)) __PYX_ERR(0, 33, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

    /* "calc_density_old.pyx":34
 *         offset = p - plower    # Offset from the left
 *         density[plower] += 1. - offset
 *         density[(plower + 1) % ncells] += offset             # <<<<<<<<<<<<<<
 *     # nparticles now distributed amongst ncells
 ...
 */
    __pyx_t_5 = __Pyx_PyInt_AddObjC(__pyx_v_plower, __pyx_int_1, 1, 0, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 34, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_9 = PyNumber_Remainder(__pyx_t_5, __pyx_v_ncells); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 34, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_density), __pyx_t_9); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 34, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = PyNumber_InPlaceAdd(__pyx_t_5, __pyx_v_offset); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 34, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    if (unlikely(PyObject_SetItem(((PyObject *)__pyx_v_density), __pyx_t_9, __pyx_t_6) < 0)) __PYX_ERR(0, 34, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
 ...
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_AsDouble(__pyx_v_ncells); if (unlikely(__pyx_t_2 == ((double)((double)-1)) && PyErr_Occurred())) __PYX_ERR(0, 36, __pyx_L1_error)
  if (unlikely(((double)__pyx_v_nparticles) == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 36, __pyx_L1_error)
  }
  __pyx_t_1 = PyFloat_FromDouble((__pyx_t_2 / ((double)__pyx_v_nparticles))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_9 = PyNumber_InPlaceMultiply(((PyObject *)__pyx_v_density), __pyx_t_1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __pyx_t_7 = ((PyArrayObject *)__pyx_t_9);
  {
    ...
    __pyx_t_10 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_density.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_10 < 0)) {
      PyErr_Fetch(&__pyx_t_11, &__pyx_t_12, &__pyx_t_13);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_density.rcbuffer->pybuffer, (PyObject*)__pyx_v_density, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
    ...
    if (unlikely(__pyx_t_10 < 0)) __PYX_ERR(0, 36, __pyx_L1_error)
  }
  __pyx_t_7 = 0;
  __Pyx_DECREF_SET(__pyx_v_density, ((PyArrayObject *)__pyx_t_9));
  __pyx_t_9 = 0;

  /* "calc_density_old.pyx":37
 *     # nparticles now distributed amongst ncells
 *     density *= float(ncells) / float(nparticles)  # Make average density equal to 1
 *     return density             # <<<<<<<<<<<<<<
 * 
...
static int __pyx_pymod_exec_calc_density_old(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_calc_density_old},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_calc_density_old, __pyx_k_calc_density_old, sizeof(__pyx_k_calc_density_old), 0, 0, 1, 1},
  {&__pyx_kp_s_calc_density_old_pyx, __pyx_k_calc_density_old_pyx, sizeof(__pyx_k_calc_density_old_pyx), 0, 0, 1, 0},
 ...
 * 
 */
  __pyx_tuple__8 = PyTuple_Pack(9, __pyx_n_s_position, __pyx_n_s_ncells, __pyx_n_s_L, __pyx_n_s_dx, __pyx_n_s_nparticles, __pyx_n_s_density, __pyx_n_s_p, __pyx_n_s_plower, __pyx_n_s_offset); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(3, 0, 9, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_calc_density_old_pyx, __pyx_n_s_calc_density_old, 13, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcalc_density_old(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcalc_density_old(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_calc_density_old(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_calc_density_old(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_calc_density_old(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'calc_density_old' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_calc_density_old(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("calc_density_old", __pyx_methods, __pyx_k_Created_on_Fri_Feb_12_00_43_46, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_calc_density_old) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "calc_density_old")) {
      if (unlikely(PyDict_SetItemString(modules, "calc_density_old", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_16calc_density_old_1calc_density_old, NULL, __pyx_n_s_calc_density_old); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_calc_density_old, __pyx_t_1) < 0) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "calc_density_old.pyx":1
 * #!/usr/bin/env python3             # <<<<<<<<<<<<<<
 * # -*- coding: utf-8 -*-
 * """
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init calc_density_old", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init calc_density_old");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
