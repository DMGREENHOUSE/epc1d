...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "calc_density_adapted",
        "sources": [
            "calc_density_adapted.pyx"
        ]
    },
    "module_name": "calc_density_adapted"
}
END: Cython Metadata */
...
#define __PYX_HAVE__calc_density_adapted
#define __PYX_HAVE_API__calc_density_adapted
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'calc_density_adapted' */
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "calc_density_adapted"
extern int __pyx_module_is_main_calc_density_adapted;
int __pyx_module_is_main_calc_density_adapted = 0;

/* Implementation of 'calc_density_adapted' */
...
static const char __pyx_k_dx_c[] = "dx_c";
...
static const char __pyx_k_density_c[] = "density_c";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_concatenate[] = "concatenate";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_nparticles_c[] = "nparticles_c";
static const char __pyx_k_density_next_c[] = "density_next_c";
static const char __pyx_k_position_cell_c[] = "position_cell_c";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_calc_density_adapted[] = "calc_density_adapted";
static const char __pyx_k_calc_density_adapted_pyx[] = "calc_density_adapted.pyx";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_Created_on_Fri_Feb_12_00_43_46[] = "\nCreated on Fri Feb 12 00:43:46 2021\n\n@author: dmg530\n";
...
static PyObject *__pyx_n_s_calc_density_adapted;
static PyObject *__pyx_kp_s_calc_density_adapted_pyx;
static PyObject *__pyx_n_s_cline_in_traceback;
static PyObject *__pyx_n_s_concatenate;
static PyObject *__pyx_n_s_density_c;
static PyObject *__pyx_n_s_density_next_c;
static PyObject *__pyx_n_s_dx_c;
...
static PyObject *__pyx_n_s_nparticles_c;
...
static PyObject *__pyx_n_s_position_cell_c;
static PyObject *__pyx_n_s_range;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_kp_u_unknown_dtype_code_in_numpy_pxd;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_20calc_density_adapted_calc_density_adapted(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_position, int __pyx_v_ncells, double __pyx_v_L); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_20calc_density_adapted_1calc_density_adapted(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_20calc_density_adapted_calc_density_adapted[] = " Calculate charge density given particle positions\n    \n    Input\n      position  - Array of positions, one for each particle\n                  assumed to be between 0 and L\n      ncells    - Number of cells\n      L         - Length of the domain\n\n    Output\n      density   - contains 1 if evenly distributed\n    ";
static PyMethodDef __pyx_mdef_20calc_density_adapted_1calc_density_adapted = {"calc_density_adapted", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_20calc_density_adapted_1calc_density_adapted, METH_VARARGS|METH_KEYWORDS, __pyx_doc_20calc_density_adapted_calc_density_adapted};
static PyObject *__pyx_pw_20calc_density_adapted_1calc_density_adapted(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_position = 0;
  int __pyx_v_ncells;
  double __pyx_v_L;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("calc_density_adapted (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_position,&__pyx_n_s_ncells,&__pyx_n_s_L,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ncells)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("calc_density_adapted", 1, 3, 3, 1); __PYX_ERR(0, 14, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_L)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calc_density_adapted", 1, 3, 3, 2); __PYX_ERR(0, 14, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "calc_density_adapted") < 0)) __PYX_ERR(0, 14, __pyx_L3_error)
      }
    ...
    __pyx_v_ncells = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_ncells == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
    __pyx_v_L = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_L == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("calc_density_adapted", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 14, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("calc_density_adapted.calc_density_adapted", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_position), __pyx_ptype_5numpy_ndarray, 1, "position", 0))) __PYX_ERR(0, 14, __pyx_L1_error)
  __pyx_r = __pyx_pf_20calc_density_adapted_calc_density_adapted(__pyx_self, __pyx_v_position, __pyx_v_ncells, __pyx_v_L);
...
static PyObject *__pyx_pf_20calc_density_adapted_calc_density_adapted(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_position, int __pyx_v_ncells, double __pyx_v_L) {
  double __pyx_v_dx_c;
  PyArrayObject *__pyx_v_position_cell_c = 0;
  int __pyx_v_nparticles_c;
  PyArrayObject *__pyx_v_density_c = 0;
  PyArrayObject *__pyx_v_density_next_c = 0;
  double __pyx_v_p;
  double __pyx_v_offset;
  int __pyx_v_plower;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_density_c;
  __Pyx_Buffer __pyx_pybuffer_density_c;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_density_next_c;
  __Pyx_Buffer __pyx_pybuffer_density_next_c;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_position;
  __Pyx_Buffer __pyx_pybuffer_position;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_position_cell_c;
  __Pyx_Buffer __pyx_pybuffer_position_cell_c;
  ...
  __Pyx_RefNannySetupContext("calc_density_adapted", 0);
  __pyx_pybuffer_position_cell_c.pybuffer.buf = NULL;
  __pyx_pybuffer_position_cell_c.refcount = 0;
  __pyx_pybuffernd_position_cell_c.data = NULL;
  __pyx_pybuffernd_position_cell_c.rcbuffer = &__pyx_pybuffer_position_cell_c;
  __pyx_pybuffer_density_c.pybuffer.buf = NULL;
  __pyx_pybuffer_density_c.refcount = 0;
  __pyx_pybuffernd_density_c.data = NULL;
  __pyx_pybuffernd_density_c.rcbuffer = &__pyx_pybuffer_density_c;
  __pyx_pybuffer_density_next_c.pybuffer.buf = NULL;
  __pyx_pybuffer_density_next_c.refcount = 0;
  __pyx_pybuffernd_density_next_c.data = NULL;
  __pyx_pybuffernd_density_next_c.rcbuffer = &__pyx_pybuffer_density_next_c;
  ...
  __pyx_pybuffernd_position.rcbuffer = &__pyx_pybuffer_position;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_position.rcbuffer->pybuffer, (PyObject*)__pyx_v_position, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 14, __pyx_L1_error)
  }
 ...
 */
  if (unlikely(__pyx_v_ncells == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 26, __pyx_L1_error)
  }
  __pyx_v_dx_c = (__pyx_v_L / ((double)__pyx_v_ncells));

  /* "calc_density_adapted.pyx":27
 *     """
 *     cdef double dx_c = L / ncells       # Uniform cell spacing
 *     cdef np.ndarray[double, ndim=1] position_cell_c = position/dx_c# converting position into a cell number             # <<<<<<<<<<<<<<
 *     cdef int nparticles_c = len(position)
 ...
 */
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_dx_c); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyNumber_Divide(((PyObject *)__pyx_v_position), __pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 27, __pyx_L1_error)
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_position_cell_c.rcbuffer->pybuffer, (PyObject*)__pyx_t_3, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_position_cell_c = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_position_cell_c.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 27, __pyx_L1_error)
    } else {__pyx_pybuffernd_position_cell_c.diminfo[0].strides = __pyx_pybuffernd_position_cell_c.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_position_cell_c.diminfo[0].shape = __pyx_pybuffernd_position_cell_c.rcbuffer->pybuffer.shape[0];
    }
  }
  __pyx_t_3 = 0;
  __pyx_v_position_cell_c = ((PyArrayObject *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "calc_density_adapted.pyx":28
 *     cdef double dx_c = L / ncells       # Uniform cell spacing
 *     cdef np.ndarray[double, ndim=1] position_cell_c = position/dx_c# converting position into a cell number
 *     cdef int nparticles_c = len(position)             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[double, ndim=1] density_c = np.zeros([ncells])
 ...
 */
  __pyx_t_4 = PyObject_Length(((PyObject *)__pyx_v_position)); if (unlikely(__pyx_t_4 == ((Py_ssize_t)-1))) __PYX_ERR(0, 28, __pyx_L1_error)
  __pyx_v_nparticles_c = __pyx_t_4;

  /* "calc_density_adapted.pyx":29
 *     cdef np.ndarray[double, ndim=1] position_cell_c = position/dx_c# converting position into a cell number
 *     cdef int nparticles_c = len(position)
 *     cdef np.ndarray[double, ndim=1] density_c = np.zeros([ncells])             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[double, ndim=1] density_next_c = np.zeros([ncells+1])
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_ncells); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_density_c.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_density_c = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_density_c.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 29, __pyx_L1_error)
    } else {__pyx_pybuffernd_density_c.diminfo[0].strides = __pyx_pybuffernd_density_c.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_density_c.diminfo[0].shape = __pyx_pybuffernd_density_c.rcbuffer->pybuffer.shape[0];
    }
  }
  __pyx_t_7 = 0;
  __pyx_v_density_c = ((PyArrayObject *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "calc_density_adapted.pyx":30
 *     cdef int nparticles_c = len(position)
 *     cdef np.ndarray[double, ndim=1] density_c = np.zeros([ncells])
 *     cdef np.ndarray[double, ndim=1] density_next_c = np.zeros([ncells+1])             # <<<<<<<<<<<<<<
 *     cdef double p, offset
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyInt_From_long((__pyx_v_ncells + 1)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_density_next_c.rcbuffer->pybuffer, (PyObject*)__pyx_t_8, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_density_next_c = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_density_next_c.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 30, __pyx_L1_error)
    } else {__pyx_pybuffernd_density_next_c.diminfo[0].strides = __pyx_pybuffernd_density_next_c.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_density_next_c.diminfo[0].shape = __pyx_pybuffernd_density_next_c.rcbuffer->pybuffer.shape[0];
    }
  }
  __pyx_t_8 = 0;
  __pyx_v_density_next_c = ((PyArrayObject *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "calc_density_adapted.pyx":33
 *     cdef double p, offset
 *     cdef int plower
 ...
 */
  if (likely(PyList_CheckExact(((PyObject *)__pyx_v_position_cell_c))) || PyTuple_CheckExact(((PyObject *)__pyx_v_position_cell_c))) {
    __pyx_t_2 = ((PyObject *)__pyx_v_position_cell_c); __Pyx_INCREF(__pyx_t_2); __pyx_t_4 = 0;
    __pyx_t_9 = NULL;
  } else {
    __pyx_t_4 = -1; __pyx_t_2 = PyObject_GetIter(((PyObject *)__pyx_v_position_cell_c)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 33, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
  ...
  for (;;) {
    if (likely(!__pyx_t_9)) {
      if (likely(PyList_CheckExact(__pyx_t_2))) {
        ...
        __pyx_t_6 = PyList_GET_ITEM(__pyx_t_2, __pyx_t_4); __Pyx_INCREF(__pyx_t_6); __pyx_t_4++; if (unlikely(0 < 0)) __PYX_ERR(0, 33, __pyx_L1_error)
        #else
        __pyx_t_6 = PySequence_ITEM(__pyx_t_2, __pyx_t_4); __pyx_t_4++; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 33, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        #endif
      } else {
        if (__pyx_t_4 >= PyTuple_GET_SIZE(__pyx_t_2)) break;
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_6 = PyTuple_GET_ITEM(__pyx_t_2, __pyx_t_4); __Pyx_INCREF(__pyx_t_6); __pyx_t_4++; if (unlikely(0 < 0)) __PYX_ERR(0, 33, __pyx_L1_error)
        #else
        __pyx_t_6 = PySequence_ITEM(__pyx_t_2, __pyx_t_4); __pyx_t_4++; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 33, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        #endif
 ...
 */
    __pyx_v_plower = ((int)__pyx_v_p);

    /* "calc_density_adapted.pyx":35
 *     for p in position_cell_c:    # Loop over all the particles, converting position into a cell number
 *         plower = int(p)        # Cell to the left (rounding down)
 *         offset = p - plower    # Offset from the left             # <<<<<<<<<<<<<<
 *         density_c[plower] += 1. - offset
 ...
 */
    __pyx_v_offset = (__pyx_v_p - __pyx_v_plower);

    /* "calc_density_adapted.pyx":36
 *         plower = int(p)        # Cell to the left (rounding down)
 *         offset = p - plower    # Offset from the left
 *         density_c[plower] += 1. - offset             # <<<<<<<<<<<<<<
 *         density_next_c[plower+1] += offset
 ...
 */
    __pyx_t_11 = __pyx_v_plower;
    __pyx_t_12 = -1;
    if (__pyx_t_11 < 0) {
      __pyx_t_11 += __pyx_pybuffernd_density_c.diminfo[0].shape;
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_11 >= __pyx_pybuffernd_density_c.diminfo[0].shape)) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 36, __pyx_L1_error)
    }
    *__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_density_c.rcbuffer->pybuffer.buf, __pyx_t_11, __pyx_pybuffernd_density_c.diminfo[0].strides) += (1. - __pyx_v_offset);

    /* "calc_density_adapted.pyx":37
 *         offset = p - plower    # Offset from the left
 *         density_c[plower] += 1. - offset
 *         density_next_c[plower+1] += offset             # <<<<<<<<<<<<<<
 *     density_next_c = np.concatenate(([density_next_c[-1]],density_next_c[1:-1]))
 ...
 */
    __pyx_t_13 = (__pyx_v_plower + 1);
    __pyx_t_12 = -1;
    if (__pyx_t_13 < 0) {
      __pyx_t_13 += __pyx_pybuffernd_density_next_c.diminfo[0].shape;
      if (unlikely(__pyx_t_13 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_13 >= __pyx_pybuffernd_density_next_c.diminfo[0].shape)) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 37, __pyx_L1_error)
    }
    *__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_density_next_c.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_density_next_c.diminfo[0].strides) += __pyx_v_offset;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_concatenate); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_14 = -1L;
  __pyx_t_12 = -1;
  if (__pyx_t_14 < 0) {
    __pyx_t_14 += __pyx_pybuffernd_density_next_c.diminfo[0].shape;
    if (unlikely(__pyx_t_14 < 0)) __pyx_t_12 = 0;
  } else if (unlikely(__pyx_t_14 >= __pyx_pybuffernd_density_next_c.diminfo[0].shape)) __pyx_t_12 = 0;
  if (unlikely(__pyx_t_12 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_12);
    __PYX_ERR(0, 38, __pyx_L1_error)
  }
  __pyx_t_6 = PyFloat_FromDouble((*__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_density_next_c.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_density_next_c.diminfo[0].strides))); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  ...
  __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_density_next_c), __pyx_slice_); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  ...
  __pyx_t_2 = (__pyx_t_6) ? __Pyx_PyObject_Call2Args(__pyx_t_1, __pyx_t_6, __pyx_t_15) : __Pyx_PyObject_CallOneArg(__pyx_t_1, __pyx_t_15);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_density_next_c.rcbuffer->pybuffer);
    __pyx_t_12 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_density_next_c.rcbuffer->pybuffer, (PyObject*)__pyx_t_8, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_12 < 0)) {
      PyErr_Fetch(&__pyx_t_16, &__pyx_t_17, &__pyx_t_18);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_density_next_c.rcbuffer->pybuffer, (PyObject*)__pyx_v_density_next_c, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
    ...
    __pyx_pybuffernd_density_next_c.diminfo[0].strides = __pyx_pybuffernd_density_next_c.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_density_next_c.diminfo[0].shape = __pyx_pybuffernd_density_next_c.rcbuffer->pybuffer.shape[0];
    if (unlikely(__pyx_t_12 < 0)) __PYX_ERR(0, 38, __pyx_L1_error)
  }
  __pyx_t_8 = 0;
  __Pyx_DECREF_SET(__pyx_v_density_next_c, ((PyArrayObject *)__pyx_t_2));
  __pyx_t_2 = 0;

  /* "calc_density_adapted.pyx":39
 *         density_next_c[plower+1] += offset
 *     density_next_c = np.concatenate(([density_next_c[-1]],density_next_c[1:-1]))
 *     density_c += density_next_c             # <<<<<<<<<<<<<<
 *     density_c *= ncells / nparticles_c  # Make average density equal to 1
 *     return density_c
 */
  __pyx_t_2 = PyNumber_InPlaceAdd(((PyObject *)__pyx_v_density_c), ((PyObject *)__pyx_v_density_next_c)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (!(likely(((__pyx_t_2) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_2, __pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 39, __pyx_L1_error)
  __pyx_t_7 = ((PyArrayObject *)__pyx_t_2);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_density_c.rcbuffer->pybuffer);
    __pyx_t_12 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_density_c.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_12 < 0)) {
      PyErr_Fetch(&__pyx_t_18, &__pyx_t_17, &__pyx_t_16);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_density_c.rcbuffer->pybuffer, (PyObject*)__pyx_v_density_c, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
    ...
    __pyx_pybuffernd_density_c.diminfo[0].strides = __pyx_pybuffernd_density_c.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_density_c.diminfo[0].shape = __pyx_pybuffernd_density_c.rcbuffer->pybuffer.shape[0];
    if (unlikely(__pyx_t_12 < 0)) __PYX_ERR(0, 39, __pyx_L1_error)
  }
  __pyx_t_7 = 0;
  __Pyx_DECREF_SET(__pyx_v_density_c, ((PyArrayObject *)__pyx_t_2));
  __pyx_t_2 = 0;

  /* "calc_density_adapted.pyx":40
 *     density_next_c = np.concatenate(([density_next_c[-1]],density_next_c[1:-1]))
 *     density_c += density_next_c
 *     density_c *= ncells / nparticles_c  # Make average density equal to 1             # <<<<<<<<<<<<<<
 *     return density_c
 * 
 */
  if (unlikely(__pyx_v_nparticles_c == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 40, __pyx_L1_error)
  }
  __pyx_t_2 = PyFloat_FromDouble((((double)__pyx_v_ncells) / ((double)__pyx_v_nparticles_c))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = PyNumber_InPlaceMultiply(((PyObject *)__pyx_v_density_c), __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __pyx_t_7 = 0;
  __Pyx_DECREF_SET(__pyx_v_density_c, ((PyArrayObject *)__pyx_t_1));
  __pyx_t_1 = 0;

  /* "calc_density_adapted.pyx":41
 *     density_c += density_next_c
 *     density_c *= ncells / nparticles_c  # Make average density equal to 1
 *     return density_c             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_INCREF(((PyObject *)__pyx_v_density_c));
  __pyx_r = ((PyObject *)__pyx_v_density_c);
  goto __pyx_L0;
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_position_cell_c.rcbuffer->pybuffer);
  ...
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_position_cell_c.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF((PyObject *)__pyx_v_position_cell_c);
  __Pyx_XDECREF((PyObject *)__pyx_v_density_c);
  __Pyx_XDECREF((PyObject *)__pyx_v_density_next_c);
...
static int __pyx_pymod_exec_calc_density_adapted(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_calc_density_adapted},
  {0, NULL}
};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "calc_density_adapted",
    __pyx_k_Created_on_Fri_Feb_12_00_43_46, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_calc_density_adapted, __pyx_k_calc_density_adapted, sizeof(__pyx_k_calc_density_adapted), 0, 0, 1, 1},
  {&__pyx_kp_s_calc_density_adapted_pyx, __pyx_k_calc_density_adapted_pyx, sizeof(__pyx_k_calc_density_adapted_pyx), 0, 0, 1, 0},
  {&__pyx_n_s_cline_in_traceback, __pyx_k_cline_in_traceback, sizeof(__pyx_k_cline_in_traceback), 0, 0, 1, 1},
  {&__pyx_n_s_concatenate, __pyx_k_concatenate, sizeof(__pyx_k_concatenate), 0, 0, 1, 1},
  {&__pyx_n_s_density_c, __pyx_k_density_c, sizeof(__pyx_k_density_c), 0, 0, 1, 1},
  {&__pyx_n_s_density_next_c, __pyx_k_density_next_c, sizeof(__pyx_k_density_next_c), 0, 0, 1, 1},
  {&__pyx_n_s_dx_c, __pyx_k_dx_c, sizeof(__pyx_k_dx_c), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_nparticles_c, __pyx_k_nparticles_c, sizeof(__pyx_k_nparticles_c), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_position_cell_c, __pyx_k_position_cell_c, sizeof(__pyx_k_position_cell_c), 0, 0, 1, 1},
 ...
 *     density_c *= ncells / nparticles_c  # Make average density equal to 1
 */
  __pyx_slice_ = PySlice_New(__pyx_int_1, __pyx_int_neg_1, Py_None); if (unlikely(!__pyx_slice_)) __PYX_ERR(0, 38, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__9 = PyTuple_Pack(11, __pyx_n_s_position, __pyx_n_s_ncells, __pyx_n_s_L, __pyx_n_s_dx_c, __pyx_n_s_position_cell_c, __pyx_n_s_nparticles_c, __pyx_n_s_density_c, __pyx_n_s_density_next_c, __pyx_n_s_p, __pyx_n_s_offset, __pyx_n_s_plower); if (unlikely(!__pyx_tuple__9)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__9);
  __Pyx_GIVEREF(__pyx_tuple__9);
  __pyx_codeobj__10 = (PyObject*)__Pyx_PyCode_New(3, 0, 11, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__9, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_calc_density_adapted_pyx, __pyx_n_s_calc_density_adapted, 14, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__10)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcalc_density_adapted(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcalc_density_adapted(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_calc_density_adapted(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_calc_density_adapted(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_calc_density_adapted(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'calc_density_adapted' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_calc_density_adapted(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("calc_density_adapted", __pyx_methods, __pyx_k_Created_on_Fri_Feb_12_00_43_46, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_calc_density_adapted) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "calc_density_adapted")) {
      if (unlikely(PyDict_SetItemString(modules, "calc_density_adapted", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_20calc_density_adapted_1calc_density_adapted, NULL, __pyx_n_s_calc_density_adapted); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_calc_density_adapted, __pyx_t_1) < 0) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "calc_density_adapted.pyx":1
 * #!/usr/bin/env python3             # <<<<<<<<<<<<<<
 * # -*- coding: utf-8 -*-
 * """
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init calc_density_adapted", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init calc_density_adapted");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
